...
model = resshape_data('./results/Midcadnoshbp-e3t10.result')
...
with(model[model$time==8460,],lines(distance,Bicoid*10^3,'l',col='hotpink'))
...
with(model[model$time==8460,],lines(distance,Hunchback*0.5*10^3,'l',col='red'))
