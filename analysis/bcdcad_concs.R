...
##
png('4-bcdcad.png',width=500,height=500)
...
plot(0,ylim=c(0,2*flyex_scale_bcd),xlim=c(0,500),main='Fig.4: Bicoid, Caudal',xlab='distance (μm)',ylab='molecules (μm⁻¹)')
...
text=c('Bicoid, literature','Caudal, literature','Bicoid','Caudal')
