...
flyex$Bicoid = flyex$intensity*1.9
flyex$stddev = flyex$stddev*1.9

##
with(flyex,plot(distance,Bicoid,'l',col='black',ylim=c(0,500),main='Fig.2: Diffusion rates'))
...
##
with(flyex,plot(distance,Bicoid,'l',col='black',ylim=c(0,500),main='Fig.3: Dynamic models at diffusion = 4μm²/s'))
with(flyex,lines(distance,Bicoid+stddev,'l',col='grey'))
with(flyex,lines(distance,Bicoid-stddev,'l',col='grey'))
...
##
with(flyex,plot(distance,Bicoid,'l',col='black',ylim=c(0,500),main='Fig.4: Complete model'))
with(flyex,lines(distance,Bicoid+stddev,'l',col='grey'))
with(flyex,lines(distance,Bicoid-stddev,'l',col='grey'))

model = resshape_data('./results/Middifs-c.result')

with(model[model$time==8460,],lines(distance,Bicoid,'p',col='red'))
